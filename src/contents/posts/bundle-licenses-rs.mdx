...
<Quiz
  ...
  answers={[
    "再配布する際に著作権表示を保持する必要がある",
    "商用利用が認められている",
    "派生物には同じライセンスを適用しなければならない",
    "著作権者は法的責任を負わない免責事項が含まれる",
  ]}
  correctAnswer={2}
  client:visible
>
  派生物に同じライセンスを適用する義務はありません。MIT
  ライセンスでは、著作権表示とライセンス文を保持する必要があり、商用利用が認められ、ソフトウェアの使用に関する法的責任から著作権者を保護する免責条項が含まれています。
</Quiz>
...
<Quiz
  ...
  answers={[
    "商用利用が禁止されている",
    "ネットワーク経由で使用される場合でもソースコード提供義務がある",
    "特許権の規定が存在しない",
    "派生物に対して異なるライセンスを適用できる",
  ]}
  correctAnswer={1}
  client:visible
>
