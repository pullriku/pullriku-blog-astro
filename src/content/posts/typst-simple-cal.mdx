...
![8月のカレンダー。上半分に海の写真が、下半分にカレンダーの表がある。](../../assets/images/posts/typst-simple-cal/aug.png)
...
![「Typstのサンプル」からはじまる文書のスクリーンショット](../../assets/images/posts/typst-simple-cal/typst_shot.png)
