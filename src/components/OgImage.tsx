...
// export const ogImageWithLogo = async (): Promise<Buffer> => {
//     const titleFont = fs.readFileSync("src/fonts/NotoSansJP-Bold.otf");

//     const width = 1200;
//     const height = 630;
//     const bgImage = fs.readFileSync("src/assets/og_image.jpeg", {encoding: "base64"});
//     const logoImage = fs.readFileSync("src/assets/rikusblog_light.png", {encoding: "base64"});
